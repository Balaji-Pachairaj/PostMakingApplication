...
const NewPost = (props) => {
     ...
     const isFormVaild =
          titleInput.isValid && nameInput.isValid && articleInput.isValid;
     const closeHandler = () => {
          modalCtx.onClose();
     };
     ...
     const submitHandler = (event) => {
          ...
          async function fetchPostData() {
               ...
               //
               const url =
                    "https://postmaking-default-rtdb.firebaseio.com/post.json";
          ...
          <div className={classes.bigBox}>
               ...
               {!isLoading && isDone && (
                    <div className={classes.done}>
                         <p>
                              Done. Your article got updated refresh to see your
                              article
                         </p>
